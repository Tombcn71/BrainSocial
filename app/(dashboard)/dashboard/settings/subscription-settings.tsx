    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Beheer je abonnement en facturering.</CardDescription>
        </CardHeader>
          ...
          <div className="rounded-md border p-4">
            <div className="flex justify-between items-start">
              ...
              <div className="text-right">
                ...
                <p className="text-sm text-muted-foreground">
                  {new Date(subscription.renewalDate).toLocaleDateString("nl-NL")}
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span>{subscription.features.aiGenerations} AI generaties per dag</span>
              </li>
              {subscription.features.contentCalendar && (
                <li className="flex items-start">
                  <CheckIcon className="h-5 w-5 text-primary mr-2 mt-0.5" />
                  <span>Geavanceerde content kalender</span>
                </li>
              )}
              <li className="flex items-start">
                <CheckIcon className="h-5 w-5 text-primary mr-2 mt-0.5" />
                <span>{subscription.features.socialChannels} social media kanalen</span>
              </li>
              ...
              {subscription.features.prioritySupport ? (
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-muted-foreground">Prioriteit ondersteuning</span>
                </li>
              )}
            </ul>
          </div>
        ...
        <CardFooter className="flex flex-col sm:flex-row gap-2">
          {subscription.plan !== "business" && (
            <Button onClick={handleUpgrade}>Upgrade naar {subscription.plan === "starter" ? "Pro" : "Business"}</Button>
          )}
